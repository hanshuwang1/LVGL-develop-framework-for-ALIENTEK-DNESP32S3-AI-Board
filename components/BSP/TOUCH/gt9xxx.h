...
/* 触摸芯片引脚相关定义 */
#define GT9XXX_INT_GPIO_PIN             GPIO_NUM_8
#define GT9XXX_CT_RST_GPIO_PIN          GPIO_NUM_11
#define GT9XXX_IIC_SDA_PIN              GPIO_NUM_21
#define GT9XXX_IIC_SCL_PIN              GPIO_NUM_12

#define GT9XXX_INT                      gpio_get_level(GT9XXX_INT_GPIO_PIN)

/* 触摸屏复位引脚 */
#define CT_RST(x)       do { x ?                              \
                            gpio_set_level(GT9XXX_CT_RST_GPIO_PIN, 1):   \
                            gpio_set_level(GT9XXX_CT_RST_GPIO_PIN, 0);   \
                        } while(0)

/* GT器件地址及IIC读写命令 */
#define GT9XXX_DEV_ID                   0x5D        /* GTXXX设备地址 */
...
extern esp_lcd_touch_handle_t s_gt9xxx_touch_handle;  /* GT9XXX触摸句柄 */
/* 函数声明 */
esp_err_t gt911_init(void);                                              /* 初始化GT911触摸屏 */
uint8_t gt911_scan(void);                                               /* 扫描GT911触摸屏 */
